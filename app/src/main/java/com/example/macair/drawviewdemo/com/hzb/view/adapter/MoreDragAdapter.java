...
public class MoreDragAdapter extends BaseAdapter implements DragGridBaseAdapter{

	private List<HashMap<String, Object>> list;
	private LayoutInflater mInflater;
	private int mHidePosition = -1;
	
	public MoreDragAdapter(Context context, List<HashMap<String, Object>> list){
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView = mInflater.inflate(R.layout.gv_more_item, null);
		...
		if ((Integer) list.get(position).get("item_image") != null)
